...
DROP TABLE IF EXISTS glpi_entities; -- Object affected by tickets
...
CREATE TABLE glpi_tickets (
    ...
    items_id NUMBER(10) NOT NULL, -- ID des éléments associés au ticket
...
CREATE TABLE glpi_treated_tickets (
    ...
    solveDate TIMESTAMP, -- Date de résolution du ticket
    ...
    items_id NUMBER(10) NOT NULL, -- ID des éléments associés au ticket traité
...
CREATE TABLE glpi_users (
    ...
    CONSTRAINT pk_users PRIMARY KEY (name, first_name, email) -- Clé primaire composite
);
